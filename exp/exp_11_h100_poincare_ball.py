...
def create_model_poincare(cfg):
    ...
    model = GraphHMSJepaPoincare(
        ...
        dropout               = getattr(cfg.model, 'dropout', 0),
        mlpmixer_dropout      = getattr(cfg.model, 'mlpmixer_dropout', 0),
...
if __name__ == "__main__":
    ...
    for dataset_name in DATASETS_TO_RUN:
        ...
        run_k_fold(updated_cfg, create_dataset, create_model_poincare, train, test)
    ...
    print("  [TRACKER] Copy results above → EXP 11 row in tracker.md")
