...
if __name__ == "__main__":
    ...
    for dataset_name in DATASETS_TO_RUN:
        ...
        if is_regression:
            tracker_results[dataset_name] = run(updated_cfg, create_dataset, create_model_ssm, train, test)
        else:
            tracker_results[dataset_name] = run_k_fold(updated_cfg, create_dataset, create_model_ssm, train, test)
    ...
    print_exp_tracker_footer(12, "Mamba-SSM Patch Encoder", tracker_results)
